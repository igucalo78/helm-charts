...
app.kubernetes.io/name: {{ include "configurator.name" . }}
...
*/}}
{{- define "configurator.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "configurator.fullname" .) .Values.serviceAccount.name }}
{{- else }}
